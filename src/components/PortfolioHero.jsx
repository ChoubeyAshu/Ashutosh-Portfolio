...
>
      ...
      <div className="flex flex-col lg:flex-row items-center justify-center lg:justify-between flex-1 px-8 lg:px-16 gap-8">
        ...
        >
          ...
          >
            Hello, <br />
            This is <span className="text-[#f9a826]">Ashutosh</span>, <br />
          ...
          >
            <a href="https://github.com/ChoubeyAshu" className="hover:text-white">
              <i className="fab fa-github"></i>
            </a>
            <a href="https://www.linkedin.com/in/choubeyashu/" className="hover:text-white">
